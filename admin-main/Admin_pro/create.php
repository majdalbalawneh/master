...
$product_name = $description =$price  =$shop= $status = $img= "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($productname_err) &&  empty($description_err) && empty($price_err) && empty($shop_err) && empty($status_err) && empty($img_err)){
        // Prepare an insert statement
        $sql =" INSERT INTO products(product_name,	description,price,shop,status,img) VALUES ('$product_name',	'$description','$price' ,'$shop','$status','$img');";
