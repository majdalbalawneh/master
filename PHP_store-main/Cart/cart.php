...
<body>
<div class="navbar">
        <div class="logo"><img src="../image (2).png" width="90px"> </div>
          ...
          <table class="table table-bordered table-striped text-center">
            <thead>
              ...
              <tr>
                ...
                <th>Discount Code</th>
                <th>Total Price</th>
                <th><a href="cart.php?clear=all" class="badge-danger badge p-1" onclick="return confirm('Are you sure want to clear your cart?');">
