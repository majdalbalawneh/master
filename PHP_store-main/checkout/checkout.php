   ...
   if($cart_query){
      ...
      <div class='message-container'>
         ...
         <div class='customer-details'>
            ...
            <a href='../index.php' class='btn'>Purchase Process Completed</a>
...
<section class="checkout-form" style="background-color: #f8f9fa;">
   ...
   <h1 class="heading" style="color:#f8bb04 ;">complete your order</h1>
   ...
   <div class="display-order">
      ...
      <input type="submit" value="order now" name="order_btn" class="btn" style=" background-color:#f8bb04;">
   </form>
