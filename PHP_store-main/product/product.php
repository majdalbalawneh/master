...
if(isset($_GET['add'])){
  $quantity=$_GET['quantity'];
   $time=$_GET['time'];
    $add_id = $_GET['add'];
    $id=$_GET['id_prod'];
    $adding="INSERT INTO `cart`(`product_id`, `quantity`,`time`) VALUES ('$id','$quantity','$time');";
                            ...
                            <figure class="card card-product-grid">
                                ...
                                <figcaption class="info-wrap">
                                    <div class="fix-height"style="text-align:center">
                                        ...
                                        <div class="price-wrap mt-2">
                                            <span class="price">Shop: <?php echo $row['shop']; ?> $</span><br>
                                        </div> 
                                    </div>
                                    <!-- col.// -->
                                    <div class="col" style="text-align:center">
                                       <br> <p class="card-text">Quantity:    </p>
                                           ...
                                           <br> <p class="card-text">date:    </p>

                                    <input style="text-align:center" type="date" value= "2022-09-29" name="time" class="form-control"style="width: 50px;"/>
